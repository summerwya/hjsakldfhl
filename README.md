...
A Computer Science (BSIT) major analyzes the programming/coding/terminal part of [this](https://www.youtube.com/watch?v=DMNlzf8PiEM) episode
...
Check out the terminal [here](/the-terminal.md)
...
Check it out [here](/computers-and-files.md)
